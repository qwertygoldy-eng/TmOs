(function() {
  ...
  // ============================================
  // 🔥 TimOs Mega Final - 11 источников + 4K HDR
  // Онлайн + Торренты + Авто-токен
  // ============================================

  var TOKEN = 'free_token_123';
  var HOST = 'http://showypro.com';

  // Все рабочие источники
  var ALL_SOURCES = [
    ...
    { name: '🏴‍☠️ Pidtor (21 видео, 4K)', url: HOST + '/lite/pidtor', type: 'online' },
  ...
  function component(object) {
    ...
    this.initialize = function() {
      ...
      function finish() {
        ...
        // Сортируем: сначала онлайн, потом торренты
